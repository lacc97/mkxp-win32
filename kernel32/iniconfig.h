...
class INIConfiguration {
    ...
    public:
        ...
        std::string
        getStringProperty(const std::string& sname, const std::string& name, const std::string& def = "") const;
        ...
        void
        setStringListProperty(const std::string& sname, const std::string& name, const std::vector<std::string>& val);
